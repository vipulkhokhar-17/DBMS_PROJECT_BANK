...
public class CloseAccountController {
    ...
    private void handleClose() {
        ...
        boolean success = staffService.closeAccount(accountNumber);
        if (success) {
            showSuccessAnimation("Account closed successfully.");
            accountNumberField.clear();
        } else {
            statusLabel.setText("Failed to close account. Check account number.");
            statusLabel.setStyle("-fx-text-fill: #ff5252;");
        }
    }
